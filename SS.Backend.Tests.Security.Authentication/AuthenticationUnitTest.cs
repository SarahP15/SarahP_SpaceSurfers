...
namespace SS.Backend.Tests.Security.Authentication
{
    ...
    public class AuthenticationUnitTest
    {
        private async Task CleanupTestData()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(configService.GetConnectionString()))
                {
        ...
        public async Task Authenticate_RegisteredUser_AuthenticatedBefore_Pass()
        {
            ...
            SSAuthService auth = new SSAuthService(genotp, hasher, dao, log, "g3LQ4A6$h#Z%2&t*BKs@v7GxU9$FqNpDrn");
